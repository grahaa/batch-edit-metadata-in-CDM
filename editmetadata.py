#this is a newest version of the script which does allow use on compound objects. 8-21-2022
#uses either the directories which hold the desc files for the cpd files, or the root level desc files if not a cpd

#instructions: place this file and the csv file into the same directory as the .desc files. 

"""
MUST USE PYTHON3 to execute this
"""
...
Sample csv format:
record number,fieldnickname,value
1517,dateed,1921/1933
2911,dateed,1958
3280,dateed,1960/1979

if your replacement string has commas, create csv with different delimiter such as "~" and tell the program that this is your delimiter when you run it
"""
